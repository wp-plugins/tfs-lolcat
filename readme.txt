...
== Description ==
This is an extension of Dougal Campbell's <a href="http://dougal.gunters.org/blog/2004/08/30/text-filter-suite">Text Filter Suite</a>, which is required for TFSLOLcat to work.  Posts and comments can be changed to LOLcat-style language.  By default, all posts and comments will be switched on the official LOLcat Day of 08 August  (808 is the nickname for Hawaii, where icanhascheezburger originated).

Visit the <a href="http://ben-kt.momillett.org/tfslolcat/">plugin homepage</a> for additional information.

== Installation ==

0.  Change the value of variable `$talk_like_a_lolcat` to false if you do not want your posts automatically converted to LOLcat-ese on the Official LOLcat Day of 08 August.
